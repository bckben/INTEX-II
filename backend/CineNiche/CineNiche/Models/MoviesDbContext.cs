    ...
    public partial class MoviesDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<movies_title>(entity =>
            {
                ...
                entity.Property(e => e.British_TV_Shows_Docuseries_International_TV_Shows)
                      .HasColumnName("British TV Shows Docuseries International TV Shows");

                entity.Property(e => e.Comedies_Dramas_International_Movies)
                      .HasColumnName("Comedies Dramas International Movies");

                entity.Property(e => e.Comedies_International_Movies)
                      .HasColumnName("Comedies International Movies");

                entity.Property(e => e.Comedies_Romantic_Movies)
                      .HasColumnName("Comedies Romantic Movies");

                entity.Property(e => e.Crime_TV_Shows_Docuseries)
                      .HasColumnName("Crime TV Shows Docuseries");

                entity.Property(e => e.Documentaries_International_Movies)
                      .HasColumnName("Documentaries International Movies");

                entity.Property(e => e.Dramas_International_Movies)
                      .HasColumnName("Dramas International Movies");

                entity.Property(e => e.Dramas_Romantic_Movies)
                      .HasColumnName("Dramas Romantic Movies");

                entity.Property(e => e.Family_Movies)
                      .HasColumnName("Family Movies");

                entity.Property(e => e.Horror_Movies)
                      .HasColumnName("Horror Movies");

                entity.Property(e => e.International_Movies_Thrillers)
                      .HasColumnName("International Movies Thrillers");

                entity.Property(e => e.International_TV_Shows_Romantic_TV_Shows_TV_Dramas)
                      .HasColumnName("International TV Shows Romantic TV Shows TV Dramas");

                entity.Property(e => e.Kids__TV)
                      .HasColumnName("Kids' TV");

                entity.Property(e => e.Language_TV_Shows)
                      .HasColumnName("Language TV Shows");

                entity.Property(e => e.Nature_TV)
                      .HasColumnName("Nature TV");

                entity.Property(e => e.Reality_TV)
                      .HasColumnName("Reality TV");

                entity.Property(e => e.TV_Action)
                      .HasColumnName("TV Action");

                entity.Property(e => e.TV_Comedies)
                      .HasColumnName("TV Comedies");

                entity.Property(e => e.TV_Dramas)
                      .HasColumnName("TV Dramas");

                entity.Property(e => e.Talk_Shows_TV_Comedies)
